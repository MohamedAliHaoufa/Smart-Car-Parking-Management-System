...
void keypad_init(void) {
    ...
    for (uint8 i = 0; i < 4; i++) {
        ...
        MCAL_GPIO_Init(((GPIO_TypeDef*)0x40021000UL), &Pin_Cfg);
        MCAL_GPIO_WritePin(((GPIO_TypeDef*)0x40021000UL), Keypad_ROWS_GPIO[i], 0);
    }
...
uint8 keypad_Get_Pressed_Key(void) {
    ...
    for (row_index = 0; row_index < 4; row_index++) {
        ...
        MCAL_GPIO_WritePin(((GPIO_TypeDef*)0x40021000UL), Keypad_ROWS_GPIO[row_index], 1);

        for (col_index = 0; col_index < 3; col_index++) {
            if (MCAL_GPIO_ReadPin(((GPIO_TypeDef*)0x40021000UL), Keypad_COLS_GPIO[col_index]) == 1) {

                while (MCAL_GPIO_ReadPin(((GPIO_TypeDef*)0x40021000UL), Keypad_COLS_GPIO[col_index]) == 1);


                return_char = Keypad_Buttons[row_index][col_index];
                MCAL_GPIO_WritePin(((GPIO_TypeDef*)0x40021000UL), Keypad_ROWS_GPIO[row_index], 0);
                return return_char;
            }
        }
