# 0 "drivers/Src/stm32f401xx_nvic_driver.c"
# 1 "/home/mohamed/Downloads/test/corrected4/corrected/Smart Car Parking Managment System//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "drivers/Src/stm32f401xx_nvic_driver.c"
# 16 "drivers/Src/stm32f401xx_nvic_driver.c"
# 1 "drivers/Inc/stm32f401xx_nvic_driver.h" 1
# 28 "drivers/Inc/stm32f401xx_nvic_driver.h"
...
# 29 "drivers/Inc/stm32f401xx_nvic_driver.h" 2
...
# 17 "drivers/Src/stm32f401xx_nvic_driver.c" 2
...
void MCAL_NVIC_SetPriorityGrouping(uint32 priority_grouping){
    ...
    priority_grouping &= 0x700UL;


    reg_value = ((SCB_TypeDef*)0xE000ED00UL)->AIRCR;


    reg_value ^= 0xFFFF0000UL;


    reg_value &= 0xFFFFF8FFUL;


    reg_value |= priority_grouping;


    ((SCB_TypeDef*)0xE000ED00UL)->AIRCR = reg_value;
}
...
uint32 MCAL_NVIC_GetPriorityGrouping(void){
    return ((((SCB_TypeDef*)0xE000ED00UL)->AIRCR & 0x700UL) >> 8);
}
...
void MCAL_NVIC_EnableIRQ(uint8 IRQn){
    ...
    ((NVIC_TypeDef*)0xE000E100UL)->ISER[reg_index] = (1U << IRQ_index);
}
...
void MCAL_NVIC_DisableIRQ(uint8 IRQn){
    ...
    ((NVIC_TypeDef*)0xE000E100UL)->ICER[reg_index] = (1U << IRQ_index);
}
...
uint8 MCAL_NVIC_GetPendingIRQ(uint8 IRQn){
    ...
    ret_val = ((((NVIC_TypeDef*)0xE000E100UL)->ISPR[reg_index] >> IRQ_index) & 0x01UL);
    return ret_val;
}
...
void MCAL_NVIC_SetPendingIRQ(uint8 IRQn){
    ...
    ((NVIC_TypeDef*)0xE000E100UL)->ISPR[reg_index] |= (1UL << IRQ_index);
}
...
void MCAL_NVIC_ClearPendingIRQ(uint8 IRQn){
    ...
    ((NVIC_TypeDef*)0xE000E100UL)->ICPR[reg_index] |= (1U << IRQ_index);
}
...
uint8 MCAL_NVIC_GetActive(uint8 IRQn){
    ...
    if (((NVIC_TypeDef*)0xE000E100UL)->IABR[reg_index] & (0x01UL << IRQ_index)) {
        ret_val = 1UL;
    } else {
        ret_val = 0UL;
    }
...
# 169 "drivers/Src/stm32f401xx_nvic_driver.c"
void MCAL_NVIC_SetPriority(uint8 IRQn, uint8 priority){
    ...
    ((NVIC_TypeDef*)0xE000E100UL)->IP[(4 * reg_index + IRQ_index)] = priority;
}
...
uint8 MCAL_NVIC_GetPriority(uint8 IRQn){
    ...
    return ((NVIC_TypeDef*)0xE000E100UL)->IP[(4 * reg_index + IRQ_index)];
}
...
void MCAL_NVIC_SystemReset(void){
    ((SCB_TypeDef*)0xE000ED00UL)->AIRCR = 0x05FA0000UL | (((SCB_TypeDef*)0xE000ED00UL)->AIRCR & 0x700UL) | (1UL << 2);
