...
void MCAL_RCC_Select_Clock(uint8 clock){
    switch(clock){
    case ((uint8_t)0x00):
        ((RCC_TypeDef*)0x40023800UL)->CR |= (1<<0);
        while(!((((RCC_TypeDef*)0x40023800UL)->CR >> 1) & 0x01U));
        ((RCC_TypeDef*)0x40023800UL)->CFGR &= ~(0b11UL);
        while(0x00 != ((((RCC_TypeDef*)0x40023800UL)->CFGR >> 2) & 0x03UL));
        ((RCC_TypeDef*)0x40023800UL)->CR &= ~(1UL<<16);
        ((RCC_TypeDef*)0x40023800UL)->CR &= ~(1UL<<24);
        break;
    case ((uint8_t)0x01):
        ((RCC_TypeDef*)0x40023800UL)->CR |= (1<<16);
        while(!((((RCC_TypeDef*)0x40023800UL)->CR >> 17) & 0x01U));
        ((RCC_TypeDef*)0x40023800UL)->CFGR &= ~(0b11UL);
        ((RCC_TypeDef*)0x40023800UL)->CFGR |= 0x01UL;
        while(0x01 != ((((RCC_TypeDef*)0x40023800UL)->CFGR >> 2) & 0x03UL));
        ((RCC_TypeDef*)0x40023800UL)->CR &= ~(1UL<<0);
        ((RCC_TypeDef*)0x40023800UL)->CR &= ~(1UL<<24);
        break;
    case ((uint8_t)0x02):
...
void MCAL_RCC_Enable_Peripheral(uint8 peripheral){
    switch(peripheral){
    case ((uint8_t)0x00): ((RCC_TypeDef*)0x40023800UL)->AHB1ENR |= (1<<0); break;
    case ((uint8_t)0x01): ((RCC_TypeDef*)0x40023800UL)->AHB1ENR |= (1<<1); break;
    case ((uint8_t)0x02): ((RCC_TypeDef*)0x40023800UL)->AHB1ENR |= (1<<2); break;
    case ((uint8_t)0x03): ((RCC_TypeDef*)0x40023800UL)->AHB1ENR |= (1<<3); break;
    case ((uint8_t)0x04): ((RCC_TypeDef*)0x40023800UL)->AHB1ENR |= (1<<4); break;
    case ((uint8_t)0x08): ((RCC_TypeDef*)0x40023800UL)->APB2ENR |= (1<<4); break;
    case ((uint8_t)0x09): ((RCC_TypeDef*)0x40023800UL)->APB1ENR |= (1<<17); break;
    case ((uint8_t)0x0A): ((RCC_TypeDef*)0x40023800UL)->APB2ENR |= (1<<5); break;
    case ((uint8_t)0x0B): ((RCC_TypeDef*)0x40023800UL)->APB2ENR |= (1<<12); break;
    case ((uint8_t)0x0C): ((RCC_TypeDef*)0x40023800UL)->APB1ENR |= (1<<14); break;
    case ((uint8_t)0x0D): ((RCC_TypeDef*)0x40023800UL)->APB1ENR |= (1<<21); break;
    case ((uint8_t)0x0E): ((RCC_TypeDef*)0x40023800UL)->APB1ENR |= (1<<22); break;
    case ((uint8_t)0x0F): ((RCC_TypeDef*)0x40023800UL)->AHB1ENR |= (1<<12); break;
    case ((uint8_t)0x10): ((RCC_TypeDef*)0x40023800UL)->APB1ENR |= (1<<0); break;
    case ((uint8_t)0x11): ((RCC_TypeDef*)0x40023800UL)->APB2ENR |= (1<<14); break;
    default: break;
    }
}
...
void MCAL_RCC_Reset_Peripheral(uint8 peripheral){
    switch(peripheral){
    case ((uint8_t)0x00): ((RCC_TypeDef*)0x40023800UL)->AHB1RSTR |= (1<<0); break;
    case ((uint8_t)0x01): ((RCC_TypeDef*)0x40023800UL)->AHB1RSTR |= (1<<1); break;
    case ((uint8_t)0x02): ((RCC_TypeDef*)0x40023800UL)->AHB1RSTR |= (1<<2); break;
    case ((uint8_t)0x03): ((RCC_TypeDef*)0x40023800UL)->AHB1RSTR |= (1<<3); break;
    case ((uint8_t)0x04): ((RCC_TypeDef*)0x40023800UL)->AHB1RSTR |= (1<<4); break;
    case ((uint8_t)0x08): ((RCC_TypeDef*)0x40023800UL)->APB2RSTR |= (1<<4); break;
    case ((uint8_t)0x09): ((RCC_TypeDef*)0x40023800UL)->APB1RSTR |= (1<<17); break;
    case ((uint8_t)0x0A): ((RCC_TypeDef*)0x40023800UL)->APB2RSTR |= (1<<5); break;
    case ((uint8_t)0x0B): ((RCC_TypeDef*)0x40023800UL)->APB2RSTR |= (1<<12); break;
    case ((uint8_t)0x0C): ((RCC_TypeDef*)0x40023800UL)->APB1RSTR |= (1<<14); break;
    case ((uint8_t)0x0D): ((RCC_TypeDef*)0x40023800UL)->APB1RSTR |= (1<<21); break;
    case ((uint8_t)0x0E): ((RCC_TypeDef*)0x40023800UL)->APB1RSTR |= (1<<22); break;
    case ((uint8_t)0x0F): ((RCC_TypeDef*)0x40023800UL)->AHB1RSTR |= (1<<12); break;
    case ((uint8_t)0x10): ((RCC_TypeDef*)0x40023800UL)->APB1RSTR |= (1<<0); break;
    case ((uint8_t)0x11): ((RCC_TypeDef*)0x40023800UL)->APB2RSTR |= (1<<14); break;
    default: break;
    }
}
...
uint32 MCAL_RCC_GetSYS_CLKFreq(void){
    uint32 ret_val;
    switch((((RCC_TypeDef*)0x40023800UL)->CFGR >> 2 & 0b11)){
    case 0:
        ret_val = 8000000UL;
        break;
    case 1:
...
uint32 MCAL_RCC_GetHCLKFreq(void){
    return (MCAL_RCC_GetSYS_CLKFreq() >> AHBPrescTable[((((RCC_TypeDef*)0x40023800UL)->CFGR >> 4) & 0b111)]);
}
...
uint32 MCAL_RCC_GetPCLK1Freq(void){
    ...
    clksrc = ((((RCC_TypeDef*)0x40023800UL)->CFGR >> 2) & 0x3);
    ...
    temp = ((((RCC_TypeDef*)0x40023800UL)->CFGR >> 4) & 0xF);
    ...
    temp = ((((RCC_TypeDef*)0x40023800UL)->CFGR >> 10) & 0x7);
...
uint32 MCAL_RCC_GetPCLK2Freq(void){
    ...
    uint8_t clkSrc = (((RCC_TypeDef*)0x40023800UL)->CFGR >> 2) & 0X3;
    uint8_t ahbp, apb2p;
    ...
    tmp = (((RCC_TypeDef*)0x40023800UL)->CFGR >> 4) & 0xF;
    ...
    tmp = (((RCC_TypeDef*)0x40023800UL)->CFGR >> 13) & 0x7;
...
uint32_t RCC_GetPLLOutputClock(void)
{
    ...
    plln = (((RCC_TypeDef*)0x40023800UL)->PLLCFGR >> 6) & 0x1FFU;
    pllm = (((RCC_TypeDef*)0x40023800UL)->PLLCFGR >> 0) & 0x3FU;
    pllp = ((((RCC_TypeDef*)0x40023800UL)->PLLCFGR >> 16) & 0x3U) + 1;


    if ((((RCC_TypeDef*)0x40023800UL)->PLLCFGR & ((uint32_t)0x00400000)) != 0)
    {

        pllInputFreq = 8000000U;
    }
    else
    {
