...
void MCAL_GPIO_Init(GPIO_TypeDef *GPIOx, GPIO_PinConfig_t *PinConfig) {
    ...
    if (PinConfig->GPIO_MODE <= 3) {
        ...
        if (PinConfig->GPIO_MODE == 4) {
            ((EXTI_TypeDef*)0x40013C00UL)->FTSR |= (1 << PinNumber);
            ((EXTI_TypeDef*)0x40013C00UL)->RTSR &= ~(1 << PinNumber);
        ...
        uint16 portcode = ( (GPIOx == ((GPIO_TypeDef*)0x40020000UL))?0: (GPIOx == ((GPIO_TypeDef*)0x40020400UL))?1: (GPIOx == ((GPIO_TypeDef*)0x40020800UL))?2: (GPIOx == ((GPIO_TypeDef*)0x40020C00UL))?3: (GPIOx == ((GPIO_TypeDef*)0x40021000UL))?4:0 );
        MCAL_RCC_Enable_Peripheral(((uint8_t)0x11));
        ((SYSCFG_RegDef_t*)0x40013800UL)->EXTICR[temp1] = (uint32)portcode << (4 * temp2);


        ((EXTI_TypeDef*)0x40013C00UL)->IMR |= (1 << PinNumber);
    }
...
void MCAL_GPIO_DeInit(GPIO_TypeDef *GPIOx) {
    if (GPIOx == ((GPIO_TypeDef*)0x40020000UL)) {
        ((RCC_TypeDef*)0x40023800UL)->AHB1RSTR |= (1 << 0);
        ((RCC_TypeDef*)0x40023800UL)->AHB1RSTR &= ~(1 << 0);
    } else if (GPIOx == ((GPIO_TypeDef*)0x40020400UL)) {
        ((RCC_TypeDef*)0x40023800UL)->AHB1RSTR |= (1 << 1);
        ((RCC_TypeDef*)0x40023800UL)->AHB1RSTR &= ~(1 << 1);
    } else if (GPIOx == ((GPIO_TypeDef*)0x40020800UL)) {
        ((RCC_TypeDef*)0x40023800UL)->AHB1RSTR |= (1 << 2);
        ((RCC_TypeDef*)0x40023800UL)->AHB1RSTR &= ~(1 << 2);
    } else if (GPIOx == ((GPIO_TypeDef*)0x40020C00UL)) {
        ((RCC_TypeDef*)0x40023800UL)->AHB1RSTR |= (1 << 3);
        ((RCC_TypeDef*)0x40023800UL)->AHB1RSTR &= ~(1 << 3);
    } else if (GPIOx == ((GPIO_TypeDef*)0x40021000UL)) {
        ((RCC_TypeDef*)0x40023800UL)->AHB1RSTR |= (1 << 4);
        ((RCC_TypeDef*)0x40023800UL)->AHB1RSTR &= ~(1 << 4);
    }
}
