...
# 47 "drivers/Src/stm32f401xx_spi_driver.c"
void MCAL_SPI_Init(SPI_TypeDef * SPIx, S_SPI_Config_t * Config)
{
    uint16_t tmpreg_CR1 = 0;
    uint16_t tmpreg_CR2 = 0;

    if (SPIx == ((SPI_TypeDef*)0x40013000UL))
    {
    ...
    if (Config->IRQ_Enable != (uint32_t)(0))
    {
        ...
        if (SPIx == ((SPI_TypeDef*)0x40013000UL))
        {
            ((*(volatile uint32_t *)(0xE000E100UL + 0x4)) |= 1<<(35 - 32));
        }
        else
        {
            ((*(volatile uint32_t *)(0xE000E100UL + 0x4)) |= 1<<(36 - 32));
        }
    }
...
# 114 "drivers/Src/stm32f401xx_spi_driver.c"
void MCAL_SPI_DeInit(SPI_TypeDef * SPIx)
{
    if (SPIx == ((SPI_TypeDef*)0x40013000UL))
    {
        ((*(volatile uint32_t *)(0xE000E100UL + 0x84)) &= ~(1<<(35 - 32)));
        MCAL_RCC_Reset_Peripheral(((uint8_t)0x0B));
    }
    else
    {
        ((*(volatile uint32_t *)(0xE000E100UL + 0x84)) &= ~(1<<(36 - 32)));
        MCAL_RCC_Reset_Peripheral(((uint8_t)0x0C));
    }
}
# 141 "drivers/Src/stm32f401xx_spi_driver.c"
void MCAL_SPI_SendData(SPI_TypeDef * SPIx, uint16_t * pTXBuffer, enum SPI_PollingMechanism Polling_En)
{
    if (Polling_En == Enabled)
    {
        while (!(SPIx->SR & (uint8_t)(1 << 1)));
    }
    SPIx->DR = *pTXBuffer;
}
# 163 "drivers/Src/stm32f401xx_spi_driver.c"
void MCAL_SPI_ReceiveData(SPI_TypeDef * SPIx, uint16_t * pRXBuffer, enum SPI_PollingMechanism Polling_En)
{
    if (Polling_En == Enabled)
    {
        while (!(SPIx->SR & (uint8_t)(1 << 0)));
    }
    *pRXBuffer = SPIx->DR;
}
# 184 "drivers/Src/stm32f401xx_spi_driver.c"
void MCAL_SPI_GPIO_Set_Pins(SPI_TypeDef * SPIx)
{
        ...
        if (Global_SPI_Config[0]->Device_Mode == (0x1<<2))
        {
            switch (Global_SPI_Config[0]->NSS)
            {
                case (0x1<<2):
                    ...
                    MCAL_GPIO_Init(((GPIO_TypeDef*)0x40020000UL), &PConfig);
                    break;
        ...
        if (Global_SPI_Config[1]->Device_Mode == (0x1<<2))
        {
            switch (Global_SPI_Config[1]->NSS)
            {
                case (0x1<<2):
                    ...
                    MCAL_GPIO_Init(((GPIO_TypeDef*)0x40020400UL), &PConfig);
                    break;
...
# 291 "drivers/Src/stm32f401xx_spi_driver.c"
void MCAL_SPI_Tx_Rx(SPI_TypeDef * SPIX, uint16_t * TX_RX_pBuffer, enum SPI_PollingMechanism Polling_En)
{
    if (Polling_En == Enabled)
    {
...
# 315 "drivers/Src/stm32f401xx_spi_driver.c"
void SPI1_IRQHandler(void)
{
    struct S_IRQ_SRC irq_src;
    irq_src.TXE = ((((SPI_TypeDef*)0x40013000UL)->SR & (1 << 1)) >> 1);
    irq_src.RXE = ((((SPI_TypeDef*)0x40013000UL)->SR & (1 << 0)) >> 0);
    irq_src.ERRI = ((((SPI_TypeDef*)0x40013000UL)->SR & (1 << 4)) >> 4);
    Global_SPI_Config[0]->P_IRQ_CallBack(irq_src);
}
# 333 "drivers/Src/stm32f401xx_spi_driver.c"
void SPI2_IRQHandler(void)
{
    struct S_IRQ_SRC irq_src;
    irq_src.TXE = ((((SPI_TypeDef*)0x40003800UL)->SR & (1 << 1)) >> 1);
    irq_src.RXE = ((((SPI_TypeDef*)0x40003800UL)->SR & (1 << 0)) >> 0);
    irq_src.ERRI = ((((SPI_TypeDef*)0x40003800UL)->SR & (1 << 4)) >> 4);
