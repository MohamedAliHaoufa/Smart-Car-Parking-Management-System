...
# 1141 "drivers/Inc/stm32f401xx.h" 2
...
void MCAL_USART_GPIO_Set_Pins(USART_TypeDef* USARTx) {
    ...
    if (((USART_TypeDef*)0x40011000UL) == USARTx) {
        ...
        MCAL_GPIO_Init(((GPIO_TypeDef*)0x40020000UL), &PinCfg);
        ...
        MCAL_GPIO_Init(((GPIO_TypeDef*)0x40020800UL), &PinCfg);
