...
void ST_Idle_STATE(void){
 ...
 if(Exit_Flag != 0){
  ...
  if(3 != Free_Slots){
   ...
   Exit_Flag = 0;
   Trigger_Alarm(((USART_TypeDef*)0x40004400UL));
  }
 }
...
void ST_Enter_Gate_STATE(void){
 ...
 MCAL_USART_SendString(((USART_TypeDef*)0x40011000UL), (uint8_t *)" Your Scanned ID is: ", 22);


 MCAL_USART_ReceiveData(((USART_TypeDef*)0x40011000UL), (uint16*)&ID, disable);


 MCAL_USART_SendData(((USART_TypeDef*)0x40011000UL), (uint16*)&ID, disable);
...
void ST_Exit_Gate_STATE(void){
 ...
 MCAL_USART_SendString(((USART_TypeDef*)0x40004400UL), (uint8_t *)" Your Scanned ID is: ", 22);


 MCAL_USART_ReceiveData(((USART_TypeDef*)0x40004400UL), (uint16*)&ID, disable);


 MCAL_USART_SendData(((USART_TypeDef*)0x40004400UL), (uint16*)&ID, disable);
...
void ST_Full_STATE(void){
 ...
 if(Enter_Flag != 0){
  Enter_Flag = 0;
  Trigger_Alarm(((USART_TypeDef*)0x40011000UL));
 }
