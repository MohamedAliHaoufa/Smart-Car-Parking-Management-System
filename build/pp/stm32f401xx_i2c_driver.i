...
void MCAL_I2C_Init(I2C_TypeDef *I2Cx, S_I2C_Config_t *I2C_Init_Struct)
{
    ...
    if (I2Cx == ((I2C_TypeDef*)0x40005400UL))
    {
...
# 114 "drivers/Src/stm32f401xx_i2c_driver.c"
        ...
        if (I2Cx == ((I2C_TypeDef*)0x40005400UL))
        {
            ((*(volatile uint32_t *)(0xE000E100UL + 0x0)) |= 1<<(31));
            ((*(volatile uint32_t *)(0xE000E100UL + 0x4)) |= 1<<(32 - 32));
        }
        else
        {
            ((*(volatile uint32_t *)(0xE000E100UL + 0x4)) |= 1<<(33 - 32));
            ((*(volatile uint32_t *)(0xE000E100UL + 0x4)) |= 1<<(34 - 32));
        }
        I2Cx->SR1 = 0x0;
        I2Cx->SR2 = 0x0;
    }
...
void MCAL_I2C_Deinit(I2C_TypeDef *I2Cx)
{
    if (I2Cx == ((I2C_TypeDef*)0x40005400UL))
    {
        ((*(volatile uint32_t *)(0xE000E100UL + 0x80)) &= ~(1<<(31)));
        ((*(volatile uint32_t *)(0xE000E100UL + 0x84)) &= ~(1<<(32 - 32)));
        MCAL_RCC_Reset_Peripheral(((uint8_t)0x0D));
    }
    else
    {
        ((*(volatile uint32_t *)(0xE000E100UL + 0x84)) &= ~(1<<(33 - 32)));
        ((*(volatile uint32_t *)(0xE000E100UL + 0x84)) &= ~(1<<(34 - 32)));
...
FlagStatus I2C_Get_FlagStatus(I2C_TypeDef *I2Cx, Status flag)
{
    ...
    switch (flag) {
        case I2C_Flag_Busy:
            Flag = ((I2Cx->SR2 & (0x1UL << (1U))) != 0) ? Set : Reset;
            break;

        case EV5:
            Flag = ((I2Cx->SR1 & (0x1UL << (0U))) != 0) ? Set : Reset;
            break;

        case EV6:
            Flag = ((I2Cx->SR1 & (0x1UL << (1U))) != 0) ? Set : Reset;
            break;
        ...
        case EV8:
        case EV8_1:
            Flag = ((I2Cx->SR1 & (0x1UL << (7U))) != 0) ? Set : Reset;
            break;

        case EV7:
            Flag = ((I2Cx->SR1 & (0x1UL << (6U))) != 0) ? Set : Reset;
            break;
    }
