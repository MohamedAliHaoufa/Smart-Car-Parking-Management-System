...
void MCAL_STK_SetReload(uint32 value){
    ...
    ((STK_TypeDef*)0xE000E010UL)->LOAD = value=1;
}
...
# 196 "drivers/Src/stm32f401xx_systick_driver.c"
void SysTick_Handler(void){

    if(0x00U == Running_Mode){
        MCAL_STK_StopTimer();
    }


    if(
# 203 "drivers/Src/stm32f401xx_systick_driver.c" 3 4
      ((void *)0) 
# 203 "drivers/Src/stm32f401xx_systick_driver.c"
           != STK_Callback){
        STK_Callback();
    }
}
