...
void EEPROM_Init(void)
{
    ...
    I2C1CFG.General_Call_Address_Detection = (0x1UL << (6U));
    I2C1CFG.I2C_Ack_Conrtol = (0x1UL << (10U));
...
# 45 "bsp/Src/eeprom_flash.c"
    ...
    MCAL_I2C_Set_GPIO(((I2C_TypeDef*)0x40005400UL));
    MCAL_I2C_Init(((I2C_TypeDef*)0x40005400UL), &I2C1CFG);
}
...
unsigned char EEPROM_Write_NBytes(unsigned int Memory_address, unsigned char* bytes, uint8_t Data_Length)
{
    ...
    MCAL_I2C_Master_Tx(((I2C_TypeDef*)0x40005400UL), 0x50, buffer, Data_Length + 2, WithStop, Start);
...
unsigned char EEPROM_Read_byte(unsigned int Memory_address, uint8_t *dataout, uint8_t datalen)
{
    ...
    MCAL_I2C_Master_Tx(((I2C_TypeDef*)0x40005400UL), 0x50, buffer, 2, WithoutStop, Start);
    MCAL_I2C_Master_Rx(((I2C_TypeDef*)0x40005400UL), 0x50, dataout, datalen, WithStop, Repeated);
