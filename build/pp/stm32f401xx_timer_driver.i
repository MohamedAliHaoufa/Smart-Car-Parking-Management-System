...
void Timer2_init(void)
{
    ...
    ((RCC_TypeDef*)0x40023800UL)->APB1ENR |= (1 << 0);


    ((TIM1_TypeDef*)0x40000000UL)->PSC = 7;


    ((TIM1_TypeDef*)0x40000000UL)->ARR = 0xC350;


    ((TIM1_TypeDef*)0x40000000UL)->CR1 |= (1 << 0);


    while (!((((TIM1_TypeDef*)0x40000000UL)->SR) & (1 << 0)));
}
# 61 "drivers/Src/stm32f401xx_timer_driver.c"
void dus(int us)
{

    ((TIM1_TypeDef*)0x40000000UL)->CNT = 0;


    while (((TIM1_TypeDef*)0x40000000UL)->CNT < us);
}
