...
void Servo1_Entry_Gate_Init(void)
{
    ...
    MCAL_GPIO_Init(((GPIO_TypeDef*)0x40020400UL), &PinCinfg);
}
...
void Servo1_Entry_Gate(uint8 Direction)
{
    if(Direction == 0)
    {
        ...
        MCAL_GPIO_WritePin(((GPIO_TypeDef*)0x40020400UL), 8, 1);
        dus(500);
        MCAL_GPIO_WritePin(((GPIO_TypeDef*)0x40020400UL), 8, 0);
    }
    else if(Direction == 1)
    {
...
void Servo2_Exit_Gate(uint8 Direction)
{
    if(Direction == 0)
    {
        ...
        MCAL_GPIO_WritePin(((GPIO_TypeDef*)0x40020400UL), 9, 1);
        dus(500);
        MCAL_GPIO_WritePin(((GPIO_TypeDef*)0x40020400UL), 9, 0);
    }
    else if(Direction == 1)
    {
